...
const Projects = () => (
    <FormSection 
        title="Projects"
        action={<button className="px-4 py-2 bg-blue-500 text-white rounded-lg text-sm font-semibold hover:bg-blue-600">+ Add Project</button>}
    >
        <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Input label="Project Name" id="projectName" type="text" defaultValue="E-commerce Platform" />
                <Input label="Technologies Used" id="technologies" type="text" defaultValue="React, Node.js, MongoDB" />
                <Input label="Project URL" id="projectUrl" type="url" defaultValue="https://github.com/johndoe/ecommerce" />
                <Input label="Duration" id="duration" type="text" defaultValue="3 months" />
            </div>
            <div>
                ...
                <textarea 
                    ...
                    defaultValue="Built a full-stack e-commerce platform with user authentication, payment integration, and admin dashboard. Implemented responsive design and optimized for performance."
                />
            </div>
